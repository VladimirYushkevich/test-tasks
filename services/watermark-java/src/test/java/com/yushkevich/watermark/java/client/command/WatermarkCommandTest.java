...
public class WatermarkCommandTest {
    ...
    public void testWatermarkDocument_clientTimeOut() throws Exception {
        ...
        System.out.println("before delay1: " + new SimpleDateFormat("MM/dd/yyyy HH:mm:ss.SS").format(System.currentTimeMillis()));
        String watermarkProperty = watermarkCommand.observe()
                .toBlocking().toFuture().get();
        System.out.println("after delay1: " + new SimpleDateFormat("MM/dd/yyyy HH:mm:ss.SS").format(System.currentTimeMillis()));
